...
local layoutwidget = awful.widget.keyboardlayout()
...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            arrow(theme.bg_normal, "#343434"),
            wibox.container.background(wibox.container.margin(wibox.widget { volicon, theme.volw, layout = wibox.layout.align.horizontal }, dpi(2), dpi(3)), "#343434"),
            arrow("#343434", "#777E76"),
            ...
            arrow("#C0C0A2", "#777E76"),
            wibox.container.background(wibox.container.margin(clock, dpi(3), dpi(3)), "#777E76"),
            arrow("#777E76", "alpha"),
            --]]
            s.mylayoutbox,
        },
