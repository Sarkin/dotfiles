...
theme.wallpaper                                 = "/home/kinan-sarmini/Pictures/wall.png"
theme.font                                      = "DejaVuSansMono 12"
theme.fg_normal                                 = "#DDDDFF"
-- theme.fg_focus                                  = "#EA6F81"
theme.fg_focus                                  = "#47e2e2"
theme.fg_urgent                                 = "#4ef04e"
...
local net = lain.widget.net({
    settings = function()
        widget:set_markup(markup.font(theme.font,
                          markup("#7AC82E", " " .. string.format("%02.1f KB", net_now.received))
                          .. " " ..
                          markup("#46A8C3", " " .. string.format("%02.1f KB", net_now.sent) .. " ")))
    end
})
